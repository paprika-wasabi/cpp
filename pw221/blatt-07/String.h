...
class String {
    public:
        ...
        // move String class to next array.
...
class StringSorter {
    ...
    private:
        ...
        // medthod that swap index l and r mith move.
        void swapwithmove(int l, int r);

        // help function to implementing quicksort.
        void quicksort(int l, int r);
        int partition(int l, int r);
        void quicksortwithmove(int l, int r);
        int partitionwithmove(int l, int r);
