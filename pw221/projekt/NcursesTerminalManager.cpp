...
NcursesTerminalManager::NcursesTerminalManager() {
  ...
  init_color(COLOR_GREEN, 200, 400, 100);
  init_color(COLOR_MAGENTA, 630, 200, 700);
  // Init pair of color.
...
// ____________________________________________________________________________
void NcursesTerminalManager::drawGreenBox(int row, int col, bool draw,
                                          const char* output) {
  int boxRowRel[8] = { -1, -1, -1, 0, 0, 1, 1, 1 };
  int boxColRel[8] = { -1, 0, 1, -1, 1, -1, 0, 1 };
  attron(COLOR_PAIR(4));
...
// ____________________________________________________________________________
void NcursesTerminalManager::drawBlackBox(int row, int col, bool draw,
                                          const char* output) {
  int boxRowRel[8] = { -1, -1, -1, 0, 0, 1, 1, 1 };
  int boxColRel[8] = { -1, 0, 1, -1, 1, -1, 0, 1 };
  attron(COLOR_PAIR(3));
...
// ____________________________________________________________________________
void NcursesTerminalManager::drawPurpleBox(int row, int col, bool draw,
                                          const char* output) {
  int boxRowRel[8] = { -1, -1, -1, 0, 0, 1, 1, 1 };
  int boxColRel[8] = { -1, 0, 1, -1, 1, -1, 0, 1 };
  attron(COLOR_PAIR(6));
