...
TEST(StringSorter, Swap) {
  ...
  sorter.swap(0, 2);
  sorter2.swapwithmove(0, 2);
  ASSERT_STREQ("etwas", sorter[0].c_str());
  ASSERT_STREQ("ins", sorter[1].c_str());
  ASSERT_STREQ("faul", sorter[2].c_str());
  ASSERT_STREQ("ist", sorter[3].c_str());

  ASSERT_STREQ("etwas", sorter2[0].c_str());
  ASSERT_STREQ("ins", sorter2[1].c_str());
  ASSERT_STREQ("faul", sorter2[2].c_str());
  ASSERT_STREQ("ist", sorter2[3].c_str());

  sorter.swap(1, 3);
  sorter2.swapwithmove(1, 3);
  ASSERT_STREQ("etwas", sorter[0].c_str());
  ASSERT_STREQ("ist", sorter[1].c_str());
  ASSERT_STREQ("faul", sorter[2].c_str());
  ASSERT_STREQ("ins", sorter[3].c_str());
}
...
// consist of the letters a-z correctly.
// `strcmp` gives the expected comparison
...
TEST(StringSorter, Sort) {
  ...
  sorter.bsortwithmove();
  ASSERT_STREQ("apple", sorter[0].c_str());
  ASSERT_STREQ("banana", sorter[1].c_str());
  ASSERT_STREQ("der", sorter[2].c_str());
  ASSERT_STREQ("grape", sorter[3].c_str());
  ASSERT_STREQ("ist", sorter[4].c_str());
  ASSERT_STREQ("pieapple", sorter[5].c_str());
  ASSERT_STREQ("rest", sorter[6].c_str());
  ASSERT_STREQ("schweigen", sorter[7].c_str());
  ASSERT_STREQ("world", sorter[8].c_str());
  ASSERT_STREQ("zebra", sorter[9].c_str());
